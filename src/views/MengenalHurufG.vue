<template>
    <div class="flex flex-col items-center bg-gradient-to-b from-green-200 to-blue-200 h-screen p-6">
        ...
        <div class="text-center mb-24 mt-10">
            <h1 class="text-9xl font-extrabold text-blue-700 drop-shadow-lg animate-bounce">G g</h1>
        </div>

        <!-- Gambar dengan awalan huruf 'G' -->
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            <div v-for="(image, index) in images" :key="index" @click="openModal(image.name)"
                ...
                <div class="p-4 text-center text-xl font-bold text-gray-700">
                    <span class="text-blue-700">G</span>{{ image.alt.slice(1) }}
                </div>
            </div>
        </div>
        ...
        <div v-if="isModalOpen" @click.self="closeModal"
            ...
            <div class="bg-white rounded-lg shadow-xl p-8 max-w-md w-full relative grid place-content-center">
                ...
                <h2 class="text-4xl text-center font-bold mb-2">
                    <span class="text-blue-700 text-5xl">G</span>{{ currentImageAlt.slice(1) }}
                </h2>
...
// Huruf G
import gajahImage from "../assets/mengenalHuruf/G/gambar_gajah.jpg";
import gelangImage from "../assets/mengenalHuruf/G/gambar_gelang.jpg";
import gigiImage from "../assets/mengenalHuruf/G/gambar_gigi.jpg";//gambarnya gigi susu animasi anak
import gulaImage from "../assets/mengenalHuruf/G/gambar_gula.jpg";

import audioGajah from "../assets/mengenalHuruf/G/audio_gajah.mp3";
import audioGelang from "../assets/mengenalHuruf/G/audio_gelang.mp3";
import audioGigi from "../assets/mengenalHuruf/G/audio_gigi.mp3";
import audioGula from "../assets/mengenalHuruf/G/audio_gula.mp3";
import audioHurufG from "../assets/mengenalHuruf/G/audioHuruf_g.mp3";
...
const images = [
    { name: "gajah", src: gajahImage, alt: "Gajah", audio: new Audio(audioGajah) },
    { name: "gelang", src: gelangImage, alt: "Gelang", audio: new Audio(audioGelang) },
    { name: "gigi", src: gigiImage, alt: "Gigi", audio: new Audio(audioGigi) },
    { name: "gula", src: gulaImage, alt: "Gula", audio: new Audio(audioGula) },
];

const replayAudio = new Audio(audioHurufG);
