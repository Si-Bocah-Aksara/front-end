<template>
    <div class="flex flex-col items-center bg-gradient-to-b from-green-200 to-blue-200 h-screen p-6">
        ...
        <div class="text-center mb-24 mt-10">
            <h1 class="text-9xl font-extrabold text-blue-700 drop-shadow-lg animate-bounce">R r</h1>
        </div>

        <!-- Images starting with the letter 'R' -->
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            <div v-for="(image, index) in images" :key="index" @click="openModal(image.name)"
                ...
                <div class="p-4 text-center text-xl font-bold text-gray-700">
                    <span class="text-blue-700">R</span>{{ image.alt.slice(1) }}
                </div>
            </div>
        </div>
        ...
        <div v-if="isModalOpen" @click.self="closeModal"
            ...
            <div class="bg-white rounded-lg shadow-xl p-8 max-w-md w-full relative grid place-content-center">
                ...
                <h2 class="text-4xl text-center font-bold mb-2">
                    <span class="text-blue-700 text-5xl">R</span>{{ currentImageAlt.slice(1) }}
                </h2>
...
// Huruf R
import rambutImage from "../assets/mengenalHuruf/R/gambar_rambut.jpg";
import rotiImage from "../assets/mengenalHuruf/R/gambar_roti.jpg";
import rumahImage from "../assets/mengenalHuruf/R/gambar_rumah.jpg";
import rusaImage from "../assets/mengenalHuruf/R/gambar_rusa.jpg";

import audioRambut from "../assets/mengenalHuruf/R/audio_rambut.mp3";
import audioRoti from "../assets/mengenalHuruf/R/audio_roti.mp3";
import audioRumah from "../assets/mengenalHuruf/R/audio_rumah.mp3";
import audioRusa from "../assets/mengenalHuruf/R/audio_rusa.mp3";
import audioHurufR from "../assets/mengenalHuruf/R/audioHuruf_r.mp3";
...
const images = [
    { name: "rambut", src: rambutImage, alt: "Rambut", audio: new Audio(audioRambut) },
    { name: "roti", src: rotiImage, alt: "Roti", audio: new Audio(audioRoti) },
    { name: "rumah", src: rumahImage, alt: "Rumah", audio: new Audio(audioRumah) },
    { name: "rusa", src: rusaImage, alt: "Rusa", audio: new Audio(audioRusa) },
];

const replayAudio = new Audio(audioHurufR);
