<template>
    <div class="flex flex-col items-center bg-gradient-to-b from-green-200 to-blue-200 h-screen p-6">
        ...
        <div class="text-center mb-24 mt-10">
            <h1 class="text-9xl font-extrabold text-blue-700 drop-shadow-lg animate-bounce">Y y</h1>
        </div>

        <!-- Images starting with the letter 'Y' -->
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            <div v-for="(image, index) in images" :key="index" @click="openModal(image.name)"
                ...
                <div class="p-4 text-center text-xl font-bold text-gray-700">
                    <span class="text-blue-700">Y</span>{{ image.alt.slice(1) }}
                </div>
            </div>
        </div>
        ...
        <div v-if="isModalOpen" @click.self="closeModal"
            ...
            <div class="bg-white rounded-lg shadow-xl p-8 max-w-md w-full relative grid place-content-center">
                ...
                <h2 class="text-4xl text-center font-bold mb-2">
                    <span class="text-blue-700 text-5xl">Y</span>{{ currentImageAlt.slice(1) }}
                </h2>
...
// Huruf Y
import yakImage from "../assets/mengenalHuruf/Y/gambar_yak.jpg";
import yakinikuImage from "../assets/mengenalHuruf/Y/gambar_yakiniku.jpg";
import yoyoImage from "../assets/mengenalHuruf/Y/gambar_yoyo.jpg";
import yoghurtImage from "../assets/mengenalHuruf/Y/gambar_yoghurt.jpg";

import audioYak from "../assets/mengenalHuruf/Y/audio_yak.mp3";
import audioYakiniku from "../assets/mengenalHuruf/Y/audio_yakiniku.mp3";
import audioYoyo from "../assets/mengenalHuruf/Y/audio_yoyo.mp3";
import audioYoghurt from "../assets/mengenalHuruf/Y/audio_yoghurt.mp3";
import audioHurufY from "../assets/mengenalHuruf/Y/audioHuruf_y.mp3";
...
const images = [
    { name: "yak", src: yakImage, alt: "Yak", audio: new Audio(audioYak) },
    { name: "yakiniku", src: yakinikuImage, alt: "Yakiniku", audio: new Audio(audioYakiniku) },
    { name: "yoyo", src: yoyoImage, alt: "Yoyo", audio: new Audio(audioYoyo) },
    { name: "yoghurt", src: yoghurtImage, alt: "Yoghurt", audio: new Audio(audioYoghurt) },
];

const replayAudio = new Audio(audioHurufY);
