<template>
    <div class="flex flex-col items-center bg-gradient-to-b from-green-200 to-blue-200 h-screen p-6">
        ...
        <div class="text-center mb-24 mt-10">
            <h1 class="text-9xl font-extrabold text-blue-700 drop-shadow-lg animate-bounce">J j</h1>
        </div>

        <!-- Gambar dengan awalan huruf 'J' -->
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            <div v-for="(image, index) in images" :key="index" @click="openModal(image.name)"
                ...
                <div class="p-4 text-center text-xl font-bold text-gray-700">
                    <span class="text-blue-700">J</span>{{ image.alt.slice(1) }}
                </div>
            </div>
        </div>
        ...
        <div v-if="isModalOpen" @click.self="closeModal"
            ...
            <div class="bg-white rounded-lg shadow-xl p-8 max-w-md w-full relative grid place-content-center">
                ...
                <h2 class="text-4xl text-center font-bold mb-2">
                    <span class="text-blue-700 text-5xl">J</span>{{ currentImageAlt.slice(1) }}
                </h2>
...
import jamImage from "../assets/mengenalHuruf/J/gambar_jam.jpg";
import jariImage from "../assets/mengenalHuruf/J/gambar_jari.jpg";
import jerapahImage from "../assets/mengenalHuruf/J/gambar_jerapah.jpg";
import jerukImage from "../assets/mengenalHuruf/J/gambar_jeruk.jpg";

import audioJam from "../assets/mengenalHuruf/J/audio_jam.mp3";
import audioJari from "../assets/mengenalHuruf/J/audio_jari.mp3";
import audioJerapah from "../assets/mengenalHuruf/J/audio_jerapah.mp3";//kenapa jadi jari jari motor wkwk
import audioJeruk from "../assets/mengenalHuruf/J/audio_jeruk.mp3";
import audioHurufJ from "../assets/mengenalHuruf/J/audioHuruf_j.mp3";
...
const images = [
    { name: "jam", src: jamImage, alt: "Jam", audio: new Audio(audioJam) },
    { name: "jari", src: jariImage, alt: "Jari", audio: new Audio(audioJari) },
    { name: "jerapah", src: jerapahImage, alt: "Jerapah", audio: new Audio(audioJerapah) },
    { name: "jeruk", src: jerukImage, alt: "Jeruk", audio: new Audio(audioJeruk) },
];

const replayAudio = new Audio(audioHurufJ);
