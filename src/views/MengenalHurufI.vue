<template>
    <div class="flex flex-col items-center bg-gradient-to-b from-green-200 to-blue-200 h-screen p-6">
        ...
        <div class="text-center mb-24 mt-10">
            <h1 class="text-9xl font-extrabold text-blue-700 drop-shadow-lg animate-bounce">I i</h1>
        </div>

        <!-- Gambar dengan awalan huruf 'I' -->
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            <div v-for="(image, index) in images" :key="index" @click="openModal(image.name)"
                ...
                <div class="p-4 text-center text-xl font-bold text-gray-700">
                    <span class="text-blue-700">I</span>{{ image.alt.slice(1) }}
                </div>
            </div>
        </div>
        ...
        <div v-if="isModalOpen" @click.self="closeModal"
            ...
            <div class="bg-white rounded-lg shadow-xl p-8 max-w-md w-full relative grid place-content-center">
                ...
                <h2 class="text-4xl text-center font-bold mb-2">
                    <span class="text-blue-700 text-5xl">I</span>{{ currentImageAlt.slice(1) }}
                </h2>
...
// Huruf I
import ibuImage from "../assets/mengenalHuruf/I/gambar_ibu.jpg";
import iguanaImage from "../assets/mengenalHuruf/I/gambar_iguana.jpg";
import ikanImage from "../assets/mengenalHuruf/I/gambar_ikan.jpg";
import ikatImage from "../assets/mengenalHuruf/I/gambar_ikat.jpg";

import audioIbu from "../assets/mengenalHuruf/I/audio_ibu.mp3";
import audioIguana from "../assets/mengenalHuruf/I/audio_iguana.mp3";
import audioIkan from "../assets/mengenalHuruf/I/audio_ikan.mp3";
import audioIkat from "../assets/mengenalHuruf/I/audio_ikat.mp3";
import audioHurufI from "../assets/mengenalHuruf/I/audioHuruf_i.mp3";
...
const images = [
    { name: "ibu", src: ibuImage, alt: "Ibu", audio: new Audio(audioIbu) },
    { name: "iguana", src: iguanaImage, alt: "Iguana", audio: new Audio(audioIguana) },
    { name: "ikan", src: ikanImage, alt: "Ikan", audio: new Audio(audioIkan) },
    { name: "ikat", src: ikatImage, alt: "Ikat", audio: new Audio(audioIkat) },
];

const replayAudio = new Audio(audioHurufI);
